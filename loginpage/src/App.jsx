...
function App() {
  ...
  return (
    // Sign in page
    <div className='bg-slate-100 flex flex-col justify-center rounded-xl items-center min-h-screen'>
      <div className={`bg-[#FFF] ${switchLayout?"hidden":"grid"} h-[30rem] w-[50rem] rounded-xl grid grid-cols-2 shadow-lg mt-4`}>
         <div className='bg-red-500 grid grid-col justify-center items-center text-center p-8 rounded-xl'>
      ...
      <div className={`bg-[#FFF] ${!switchLayout?"hidden":"grid"} h-[30rem] w-[50rem] rounded-xl grid grid-cols-2 shadow-lg mt-4`}>
         ...
         <div className=' bg-red-500 grid grid-col rounded-xl gap-4 justify-center items-center text-center p-8'>
